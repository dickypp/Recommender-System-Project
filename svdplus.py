...
# mencari berapa paling banyak game yang dimainkan oleh pengguna
games_user = df_sampled.groupby('User_Id')['Game_Id'].nunique().max()
print(f"Jumlah maksimum game yang dimainkan oleh pengguna: {games_user}")

...
parameters = {
    ...
    'n_epochs': [20],
    'reg_pu': [0.001, 0.003, 0.005],
    'reg_qi': [0.01, 0.03, 0.05]
}
...
for nf in parameters['n_factors']:
    for ne in parameters['n_epochs']:
        for rpu in parameters['reg_pu']:
            for rqi in parameters['reg_qi']:
                params = {
                    'n_factors': nf,
                    'n_epochs': ne,
                    'reg_pu': rpu,
                ...
                for trainset, testset in kf.split(data):
                    ...
                    print(f"Params: {params}, Fold: {fold}, RMSE: {rmse:.4f}, MAE: {mae:.4f}")
                    fold += 1
